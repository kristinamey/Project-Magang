...
import kotlinx.android.synthetic.main.fragment_tab1quisberhitung.btn_jawaban1
import kotlinx.android.synthetic.main.fragment_tab1quisberhitung.btn_jawaban2
import kotlinx.android.synthetic.main.fragment_tab1quisberhitung.btn_jawaban3
import kotlinx.android.synthetic.main.fragment_tab1quisberhitung.btn_jawaban4
import kotlinx.android.synthetic.main.fragment_tab1quisberhitung.viewsoalberhitungplus
import kotlinx.android.synthetic.main.fragment_tab2quisberhitung.*
...
class Fragment_tab2quisberhitung : Fragment() {
    var JSON_STRING = ""
    var next_page = ""
    var prev_page_url = ""
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_tab2quisberhitung, container, false)
    }

    companion object {
        fun newInstance(param1: String, param2: String) =
            Fragment_tab2quisberhitung().apply {
    ...
    private fun showEmployee() {
        try {
            ...
            viewsoalberhitungmin.loadSvgOrOthers(data[0].pertanyaan)
    ...
    private fun getJSON() {
        class GetJSON :
            ...
            override fun doInBackground(vararg params: Void?): String {
                ...
                return rh.sendGetRequest("${resources.getString(R.string.base_url)}api/quiz/?tipe=pertambahan")
            }
        }
