...
class FingerPaintImageView @JvmOverloads constructor(context: Context,
                                                     ...
                                                     defStyleAttr: Int = 0,
                                                     defStyleRes: Int = 0) :
        AppCompatImageView(context, attrs, defStyleAttr), Parcelable {
    ...
    constructor(parcel: Parcel) : this(
        ...
        brushBitmap = parcel.readParcelable(Bitmap::class.java.classLoader)
        countDrawn = parcel.readInt()
        inEditMode = parcel.readByte() != 0.toByte()
        touchTolerance = parcel.readFloat()
        currentX = parcel.readFloat()
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        parcel.writeParcelable(brushBitmap, flags)
        parcel.writeInt(countDrawn)
        parcel.writeByte(if (inEditMode) 1 else 0)
        parcel.writeFloat(touchTolerance)
    ...
    companion object CREATOR : Parcelable.Creator<FingerPaintImageView> {
        override fun createFromParcel(parcel: Parcel): FingerPaintImageView {
            return FingerPaintImageView(parcel)
        }

        override fun newArray(size: Int): Array<FingerPaintImageView?> {
